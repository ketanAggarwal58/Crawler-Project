...
const createQueueTable = "CREATE TABLE (ID BIGSERIAL PRIMARY KEY NOT NULL, Job_Name VARCHAR(255), Job_Status VARCHAR(255), Job_url VARCHAR(255), Job_Created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), Job_Updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW());";
